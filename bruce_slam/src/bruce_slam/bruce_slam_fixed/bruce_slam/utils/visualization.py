...
# See utils/conversions.py for why this prefers the ROS2 (rclpy)
# location and falls back to the ROS1 (rospy) one - this file builds
# the same PointCloud2/Marker messages that conversions.py does, and
# needs to agree with it on which point_cloud2 implementation is in use.
try:
